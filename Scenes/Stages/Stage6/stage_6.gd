...
@onready var frostContainer = get_node("World/Frosts")

@export var enemy6: PackedScene
@export var frost6: PackedScene
@export var phaser6: PackedScene
@export var booster6: PackedScene
@export var boss6: PackedScene
